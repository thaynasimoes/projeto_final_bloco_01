...
public class Menu {
    ...
    public static void main(String[] args) {
        ...
        // teste livro
        Livro livro1 = new Livro("Icebreaker", "Hannah Grace", "Romance", 201.24, 5);
        livroRepo.adicionar(livro1);
        livro1.visualizar();
        
         //teste cd
        CD cd1 = new CD("Cry Baby", "Melanie Martinez", 60.27, 13);
        cdRepo.adicionar(cd1);
        cd1.visualizar();
